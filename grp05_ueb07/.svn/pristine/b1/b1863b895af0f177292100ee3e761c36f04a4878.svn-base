...
//        MyFilledElement<Integer> e = new MyFilledElement<>(0, new MyEmptyElement<>());
...
//        final MyEmptyElement<Boolean> EMPTY = new MyEmptyElement<>();        
...
//        MyFilledElement<Integer> e = new MyFilledElement<>(99, new MyEmptyElement<>());
...
//        final MyEmptyElement<Integer> EMPTY = new MyEmptyElement<>();  
...
//        MyEmptyElement<Integer> result = e.insertAtFront(11);
...
//        final MyEmptyElement<Integer> EMPTY = new MyEmptyElement<>();  
//        MyFilledElement<Integer> e = new MyFilledElement<>(22,  new MyFilledElement<>(33, EMPTY));
//        MyEmptyElement<Integer> result = e.insertAt(0, 11);
//        assertEquals(3, result.length());
//        assertEquals(Integer.valueOf(11), result.getValueAt(0));
//        assertEquals(Integer.valueOf(22), result.getValueAt(1));
//        assertEquals(Integer.valueOf(33), result.getValueAt(2));       
...
//        MyEmptyElement<Integer> result = e.insertAt(1, 22);
//        assertEquals(3, result.length());
//        assertEquals(Integer.valueOf(11), result.getValueAt(0));
//        assertEquals(Integer.valueOf(22), result.getValueAt(1));
//        assertEquals(Integer.valueOf(33), result.getValueAt(2));       
...
//        final MyEmptyElement<Integer> EMPTY = new MyEmptyElement<>();  
//        MyFilledElement<Integer> e = new MyFilledElement<>(11,  new MyFilledElement<>(22, EMPTY));
//        MyEmptyElement<Integer> result = e.insertAt(2, 33);
//        assertEquals(3, result.length());
//        assertEquals(Integer.valueOf(11), result.getValueAt(0));
//        assertEquals(Integer.valueOf(22), result.getValueAt(1));
//        assertEquals(Integer.valueOf(33), result.getValueAt(2));       
...
//        final MyEmptyElement<Integer> EMPTY = new MyEmptyElement<>();  
//        MyFilledElement<Integer> e = new MyFilledElement<>(11,  new MyFilledElement<>(22, EMPTY));
//        MyEmptyElement<Integer> result = e.insertAt(3, 33);
...
//        final MyEmptyElement<Integer> EMPTY = new MyEmptyElement<>();  
//        MyFilledElement<Integer> e = new MyFilledElement<>(11,  new MyFilledElement<>(22, EMPTY));
//        MyEmptyElement<Integer> result = e.removeAt(0);
...
//        final MyEmptyElement<Integer> EMPTY = new MyEmptyElement<>();  
//        MyFilledElement<Integer> e = new MyFilledElement<>(11,  new MyFilledElement<>(22, EMPTY));
//        MyEmptyElement<Integer> result = e.removeAt(1);
//        assertEquals(1, result.length());
//        assertEquals(Integer.valueOf(11), result.getValueAt(0));
//    }
//    @Test 
...
//        final MyEmptyElement<Integer> EMPTY = new MyEmptyElement<>();  
//        MyFilledElement<Integer> e = new MyFilledElement<>(11,  new MyFilledElement<>(22, EMPTY));
//        MyEmptyElement<Integer> result = e.removeAt(2);
//        assertEquals(2, result.length());        
//        assertEquals(Integer.valueOf(11), result.getValueAt(0));
//        assertEquals(Integer.valueOf(22), result.getValueAt(1));
//    }
...
//        final MyEmptyElement<Integer> EMPTY = new MyEmptyElement<>();  
//        MyFilledElement<Integer> e = new MyFilledElement<>(11,  new MyFilledElement<>(22, EMPTY));
//        MyEmptyElement<Integer> result = e.append(33);
//        assertEquals(3, result.length());
//        assertEquals(Integer.valueOf(11), result.getValueAt(0));
//        assertEquals(Integer.valueOf(22), result.getValueAt(1));
//        assertEquals(Integer.valueOf(33), result.getValueAt(2)); 

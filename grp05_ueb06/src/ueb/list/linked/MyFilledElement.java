...
class MyFilledElement<E> extends MyElement<E> {
     ...
     */
    MyFilledElement(E payload, MyElement next) {
        this.Payload = payload;
        this.next = next;
    }
     ...
     */
    @Override
    public MyFilledElement append(E value) {
     ...
     */
    @Override
    public MyFilledElement insertAtFront(E value) {
     ...
     */
    @Override
    public MyElement insertAt(int index, E value) {
        if (index == 0) {
     ...
     */
    @Override
    public MyElement removeAt(int index) {
        switch (index) {
            case 0:
                return this.getNext();
            case 1:
     ...
     */
    @Override
    public MyElement filterThis(PredicateFunctionObject<E> predicate) {
